  ...
  return (
    <div>
      ...
      <div className="location-details">
        ...
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ratione aperiam accusantium animi enim totam voluptatem maiores assumenda voluptatum. Aliquam eligendi fugit error accusantium provident molestiae, temporibus aliquid accusamus veritatis, numquam iure harum est, fugiat vel libero tenetur. Totam eum obcaecati, unde mollitia error ad! Itaque repudiandae similique quae rerum quisquam!
      </div>
      <div className="map">
